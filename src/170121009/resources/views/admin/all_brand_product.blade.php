            ...
            @foreach($all_brand_product as $key => $cate_pro)
              <tr>
                ...
                <td>
                  ...
                  <a href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="" onclick="return confirm('Có chắc là xóa thương hiệu này không?')">
