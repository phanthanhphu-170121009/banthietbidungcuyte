            ...
            @foreach($all_category_product as $key => $cate_pro)
              <tr>
                ...
                <td>
                  ...
                  <a href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="" onclick="return confirm('Có chắc là xóa danh mục này không?')">
